...
if(!empty($_POST)){
    ...
    if( (int)$dbFormData['zip'] !== $zip){//DBデータをint型にキャスト（型変換して比較）
        //郵便番号形式チェック
        validZip($zip, 'zip');
    }
    ...
    <div class="form-container">
      <form action="" method="post" class="form" enctype="multipart/form-data">
        ...
        <label class="<?php if(!empty($err_msg['email'])) echo 'err'; ?>">
          Email
          <input type="text" name="email" value="<?php echo getFormData('email'); ?>" style="<?php if($_SESSION(user_id) == 22) echo 'disabled:"disabled";' ?>">
        </label>
        <div class="area-msg">
          <?php 
        ...
        <div class="btn-container" style="width:550px;">
